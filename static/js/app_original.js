...
function handleClick(){
    ...
    // Grab the datetime value from the vilter
    ...
    // Rebuild the table using the filtered data (if no data was entered,
    // then filtered data will be the original tableData)
